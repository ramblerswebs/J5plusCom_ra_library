 ...
 * @since  1.0.0
 */
class EmaillogModel extends AdminModel
{
	/**
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_ra_library.emaillog';
	 ...
	 * @since   1.0.0
	 */
	public function getTable($type = 'Emaillog', $prefix = 'Administrator', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_ra_library.edit.emaillog.data', array());
	...
	/**
	 * Method to duplicate an Emaillog
	 *
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__ra_email_log');
				$max             = $db->loadResult();
